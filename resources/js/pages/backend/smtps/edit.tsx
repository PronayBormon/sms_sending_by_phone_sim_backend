...
export default function Edit({ smtp, teams = [] }: Props) {
    const [showPassword, setShowPassword] = useState(false);

    const { data, setData, put, processing, errors } = useForm({
        team_id: smtp.team_id ? String(smtp.team_id) : "",
        host: smtp.host || "",
        port: smtp.port || "",
    ...
    return (
        <>
            <Head title="Edit SMTP Configuration" />
            <div className="row">
                <div className="col-lg-8">
                    <div className="card bg-white p-20 rounded-10 border border-white mb-4">
                        <h3 className="mb-20">Edit SMTP Server</h3>
                        ...
                        <form onSubmit={submit}>
                            <div className="row">
                                ...
                                <div className="col-lg-6 mb-20">
                                    <label className="label fs-16 mb-2">Password (Leave blank to keep unchanged)</label>
